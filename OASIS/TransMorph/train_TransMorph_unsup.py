...
def main():
    ...
    weights = [1.0, 1.0]  # [NCC, Grad3d]
    save_dir = "TransMorph_OASIS_unsup_ncc_{}_grad_{}/".format(weights[0], weights[1])
    ...
    print(f"OASIS TransMorph-unsup: train={len(train_paths)} val={len(val_paths)}")
