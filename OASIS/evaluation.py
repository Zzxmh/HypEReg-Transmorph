...
DEFAULT_INPUT_PATH = _REPO_ROOT / "OASIS" / "data" / "Submit" / "submission"
DEFAULT_GROUND_TRUTH_PATH = _REPO_ROOT / "OASIS" / "data" / "Test_nii"
DEFAULT_GROUND_CSV_PATH = _REPO_ROOT / "OASIS" / "data"
DEFAULT_EVALUATION_OUTPUT_FILE_PATH = _REPO_ROOT / "OASIS" / "data" / "Output" / "metrics.json"
...
class EvalVal():
    ...
    def score_task_03(self):
        ...
        for idx, case in self.cases_task_03.iterrows():
            self.cases_results_task_03 = pd.concat(
                [self.cases_results_task_03, DataFrame([self.score_case_task_03(idx=idx, case=case)])],
                ignore_index=True,
            )
