...
def _base_dir() -> str:
    o = os.path.join(oasis_root(), "Baseline_registration_methods", "CycleMorph")
    if os.path.isdir(o) and os.path.isfile(os.path.join(o, "CycleMorph_Validation_dsc0.729.pth.tar")):
        return o
...
def build_model(device: str = "cuda"):
    ...
    print(f"cyclemorph_oasis: loading {ckpt} (base={base})", flush=True)
