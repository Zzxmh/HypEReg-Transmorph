...
\abstract{Deformable brain MRI registration requires both accurate anatomical alignment and geometrically plausible deformation fields, yet many Transformer-based methods still generate folded deformations. We introduce HypEReg, a differentiable hyperelastic-energy regularization term (volume-distortion penalty plus anti-folding hinge) integrated into a TransMorph-style dense registration backbone during training. On a held-out IXI atlas-to-subject protocol (115 test subjects), performance was assessed using grouped anatomical Dice, Jacobian-determinant statistics, and paired Wilcoxon tests with BH-FDR correction. HypEReg-TransMorph achieved grouped Dice 0.7537, comparable to TransMorph (0.7527), while reducing non-positive Jacobian voxels from 1.50\% to 0.0015\% and improving HD95 from 5.88\,mm to 3.16\,mm. Deformation-regularity gains were statistically significant ($p < 10^{-19}$, $q < 10^{-19}$, rank-biserial $r=1.00$). Relative to TransMorphBayes, HypEReg-TransMorph also improved HD95 (3.16 vs.\ 3.37\,mm) and ASSD (0.589 vs.\ 0.622\,mm). Because HypEReg acts only during training, forward inference cost remained unchanged versus TransMorph (0.0822\,s/volume, 5.685\,GB peak memory). These findings show Jacobian-aware regularization can improve deformation plausibility without sacrificing alignment accuracy or inference efficiency.}
