...
\item Random global seed: not fixed in this training script.
\end{itemize}
...
\begin{itemize}
\item Inference benchmarks use standardized evaluation scripts with harmonized metric definitions across models.
\item Isolated forward profiling is performed with gradients disabled and without label-warp/metric kernels.
\item Measured pure-forward runtime/peak-memory: HypEReg-TransMorph \(0.4316\) s / \(5.422\) GB; TransMorph \(0.4306\) s / \(5.421\) GB.
\end{itemize}
