...
\noindent This document accompanies the manuscript \emph{HypEReg-TransMorph: A Hyperelastic-Regularized Transformer Framework for Folding-Suppressed Deformable Brain MRI Registration}. Extended quantitative results, inferential tables (S1--S2), grouped-VOI mapping (S3), Figure~S1, OASIS protocol notes with Tables~S4--S5, and implementation/profiling details are provided here as separate Supplementary Materials (they are not duplicated in the main journal PDF).
